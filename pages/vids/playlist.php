<?php
	...
	$playlist_data = $playlists['monthly'][$playlist];
	if( $playlist_data == null ) {
		$playlist_data = $playlists['kabaret'][$playlist];
	} else {
		// echo "Oh no!";
	}
...
<h1><?php if($playlist_data['num']) { echo '#'.$playlist_data['num'].': '; }?><?php echo $playlist_data['name']?></h1>
